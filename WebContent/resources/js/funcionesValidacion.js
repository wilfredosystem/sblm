...
function validacioneEditarUsuario (){
	...
	if( $("#formEditarUsuario\\:idUsuario").val() == "" ){
		$("#formEditarUsuario\\:idUsuario").focus().after("<span class='error'>Ingrese el  nombre de usuario</span>");
		return false;
	 }else if( $("#formEditarUsuario\\:idApellidos").val() == ""){
			$("#formEditarUsuario\\:idApellidos").focus().after("<span class='error'>Ingrese apellidos</span>");
			return false;
	 }else if( $("#formEditarUsuario\\:idNombre").val() == ""){
			$("#formEditarUsuario\\:idNombre").focus().after("<span class='error'>Ingrese Nombres</span>");
			return false;
	 }else 
		 if( $("#formEditarUsuario\\:idEmail").val() == ""){
				$("#formEditarUsuario\\:idEmail").focus().after("<span class='error'>Ingrese E-mail</span>");
				return false;
		 }else 
			 
//			 if( $("#formEditarUsuario\\:idNacimiento").val() == ""){
//					$("#formEditarUsuario\\:idNacimiento").focus().after("<span class='error'>Ingrese Fecha Nacimiento</span>");
//					return false;
//			 }else 
...
function validacionFranco (){
	...
	if( $("#formSuperUsuarios\\:idUsuario").val() == "" ){
		$("#formSuperUsuarios\\:idUsuario").focus().after("<span class='error'>Ingrese el  nombre de usuario</span>");
		return false;
	 }else if( $("#formSuperUsuarios\\:idApellidos").val() == ""){
			$("#formSuperUsuarios\\:idApellidos").focus().after("<span class='error'>Ingrese apellidos</span>");
			return false;
	 }else if( $("#formSuperUsuarios\\:idNombre").val() == ""){
			$("#formSuperUsuarios\\:idNombre").focus().after("<span class='error'>Ingrese Nombres</span>");
			return false;
	 }else 
		 if( $("#formSuperUsuarios\\:idEmail").val() == ""){
				$("#formSuperUsuarios\\:idEmail").focus().after("<span class='error'>Ingrese E-mail</span>");
				return false;
		 }else 
			 
//			 if( $("#formSuperUsuarios\\:idNacimiento").val() == ""){
//					$("#formSuperUsuarios\\:idNacimiento").focus().after("<span class='error'>Ingrese Fecha Nacimiento</span>");
//					return false;
//			 }else 
				 if( $("#formSuperUsuarios\\:idCargo").val() == ""){
						$("#formSuperUsuarios\\:idCargo").focus().after("<span class='error'>Ingrese nombre de Cargo</span>");
						return false;
				 }else 
					 if( $("#formSuperUsuarios\\:pwd1").val() == ""){
							$("#formSuperUsuarios\\:pwd1").focus().after("<span class='error'>Ingrese Contrase&ntilde;a</span>");
							return false;
					 }else 
						 if( $("#formSuperUsuarios\\:pwd2").val() == ""){
								$("#formSuperUsuarios\\:pwd2").focus().after("<span class='error'>Repita Contrase&ntilde;a</span>");
								return false;
						 }else if (passwordVal != checkVal ) {
					            $("#formSuperUsuarios\\:pwd2").after('<span class="error">Contrase&ntilde;as no coinciden</span>');
					            hasError = true;
					        }else 
								 if( checkVal.length<5){
										$("#formSuperUsuarios\\:pwd2").focus().after("<span class='error'> Contrase&ntilde;a minima de 5 caracteres </span>");
										return false;
								 }else 
						 	{
