...
public class NotificacionesDAOImpl implements INotificacionesDAO, Serializable {
	...
	public List listarNotificaciones(int estado, String mesSeleccionado,
		...
		String queryPendientes="select new List(EA.tipoevento,U.rutaimgusr,A.idauditoria,A.fecentrada,U.nombres,U.apellidopat,U.apellidomat) from Auditoria A inner join A.usuario U inner join A.usuariodestino UD inner join A.eventoauditoria EA" +
