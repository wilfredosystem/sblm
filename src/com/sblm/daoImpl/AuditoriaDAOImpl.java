...
//	
	...
	public List listAuditoriaFiltroPerfil(Date fechaInicio, Date fechaFin,
		...
		if(!recursoBusqueda.equals("")){
			queryNombrePantalla = "R.nompantalla='"+recursoBusqueda+"' and ";
		}
...
//		query = "" +
//		"select new List(R.idauditoria,R.modulo.nombremodulo,R.nompantalla,R.fecentrada,R.eventoauditoria.tipoevento,u.nombreusr) " +
//		"  from Auditoria R inner join R.usuario u inner join  u.perfilusuarios pu inner join pu.perfil p  inner join R.eventoauditoria EA" +
//		" where "+queryNombrePerfil+"fecentrada>='"+fInicio+"' and fecentrada<'"+fFin+"' and"+" "+queryNombrePantalla+""+queryNombreModulo+"1=1";
